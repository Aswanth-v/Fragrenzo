...
const Home = () => {
  ...
  return (
    <div className="w-full">
      ...
      <span className="flex justify-center pt-6 text-xl sm:text-2xl font-bold">
        Categories
      </span>

      <div className="w-full flex flex-wrap justify-center gap-6 md:gap-12 lg:gap-20 py-8">
